...
public class NotesList extends ListActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_toggle_eye_care_mode:
                toggleEyeCareMode();
                return true;
        case R.id.menu_add:
          /*
    ...
    private void toggleEyeCareMode() {
        SharedPreferences preferences = getSharedPreferences("NotePadPrefs", MODE_PRIVATE);
        boolean isEyeCareMode = preferences.getBoolean("EyeCareMode", false);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("EyeCareMode", !isEyeCareMode);
        editor.apply();

        // 重新加载布局以应用新的背景颜色
        int layoutResId = isEyeCareMode ? R.layout.note_editor_eye_care : R.layout.note_editor;
